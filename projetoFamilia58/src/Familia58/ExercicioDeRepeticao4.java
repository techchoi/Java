...
public class ExercicioDeRepeticao4 {
    public static void main(String[] args){
        ...
        while(pessoas<=6){
            ...
            idade = leia.nextInt();
            System.out.println("\nEntre com o genero: (1)Feminino\n(2)Masculino\n(3)Não declarado.");
            genero = leia.nextInt();
            System.out.println("\nEntre com o seu fator psicológioc:\n(1)Calma\n(2)Nervosa\n(3)Agressivo ");
            fp = leia.nextInt();

            if(fp == 1){contPc++;}

            if(genero == 1 && fp == 2){contMn++;}

            if(genero == 2 && fp == 3){contHa++;}

            if(genero == 3 && fp == 1){contNdc++;}

            if(fp == 2 && idade > 40){contPn40++;}

            if(fp == 1 && idade < 18){contPc18++;}
